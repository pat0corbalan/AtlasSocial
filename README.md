...
Aplicación web para relevamiento territorial y gestión de información social y electoral, desarrollada para funcionar de manera online y responsive en celulares, tablets y PC.
...
- Teléfono
- Intención de voto
- Cantidad de votantes por domicilio
